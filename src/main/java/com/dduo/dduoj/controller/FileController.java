...
import com.dduo.dduoj.constant.FileConstant;
import com.dduo.dduoj.exception.BusinessException;
import com.dduo.dduoj.manager.CosManager;
import com.dduo.dduoj.model.dto.file.UploadFileRequest;
import com.dduo.dduoj.model.entity.User;
import com.dduo.dduoj.model.enums.FileUploadBizEnum;
...
public class FileController {
    ...
    public BaseResponse<String> uploadFile(@RequestPart("file") MultipartFile multipartFile,
        ...
        String filepath = String.format("/%s/%s/%s", fileUploadBizEnum.getValue(), ((User) loginUser).getId(), filename);
        File file = null;
        try {
            // 上传文件
